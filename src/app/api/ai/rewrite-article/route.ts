...
export async function POST(request: Request) {
  try {
    ...
    const context = slotContext[slot] ?? "This is a general news story for The Daily Farcaster Tribune.";
    ...
    const prompt = `You are a senior journalist at The Daily Farcaster Tribune, a daily newspaper for the Farcaster web3 social protocol. Write in the style of a quality broadsheet — authoritative, informative, and accessible to readers who may not know all the technical details.
...
- byline: Author credit (e.g. "By Staff Reporter" or "By ${author} · Reported by Tribune Staff")
